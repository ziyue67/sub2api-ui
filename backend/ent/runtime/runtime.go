...
func init() {
	...
	// groupDescDynamicRateMarkup is the schema descriptor for dynamic_rate_markup field.
	groupDescDynamicRateMarkup := groupFields[4].Descriptor()
	// group.DefaultDynamicRateMarkup holds the default value on creation for the dynamic_rate_markup field.
	group.DefaultDynamicRateMarkup = groupDescDynamicRateMarkup.Default.(float64)
	// groupDescDynamicRateSourceMultiplier is the schema descriptor for dynamic_rate_source_multiplier field.
	groupDescDynamicRateSourceMultiplier := groupFields[5].Descriptor()
	// group.DefaultDynamicRateSourceMultiplier holds the default value on creation for the dynamic_rate_source_multiplier field.
	group.DefaultDynamicRateSourceMultiplier = groupDescDynamicRateSourceMultiplier.Default.(float64)
	...
	usagelogDescImageOutputTokens := usagelogFields[21].Descriptor()
