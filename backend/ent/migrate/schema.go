...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "group_routes", Type: field.TypeJSON, Nullable: true},
	...
	AnnouncementsColumns = []*schema.Column{
		...
		{Name: "ticker_enabled", Type: field.TypeBool, Default: true},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "dynamic_rate_markup", Type: field.TypeFloat64, Default: 1.25, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "dynamic_rate_source_multiplier", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
