...
type Group struct {
	...
	// DynamicRateEnabled holds the value of the "dynamic_rate_enabled" field.
	DynamicRateEnabled bool `json:"dynamic_rate_enabled,omitempty"`
	// DynamicRateMarkup holds the value of the "dynamic_rate_markup" field.
	DynamicRateMarkup float64 `json:"dynamic_rate_markup,omitempty"`
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldRateMultiplier, group.FieldDynamicRateMarkup, group.FieldDynamicRateSourceMultiplier, group.FieldPeakRateMultiplier, group.FieldDailyLimitUsd, group.FieldWeeklyLimitUsd, group.FieldMonthlyLimitUsd, group.FieldImageRateMultiplier, group.FieldImagePrice1k, group.FieldImagePrice2k, group.FieldImagePrice4k, group.FieldBatchImageDiscountMultiplier, group.FieldBatchImageHoldMultiplier, group.FieldVideoRateMultiplier, group.FieldVideoPrice480p, group.FieldVideoPrice720p, group.FieldVideoPrice1080p, group.FieldWebSearchPricePerCall, group.FieldSearchPricePer1k, group.FieldAudioRealtimePricePerMin, group.FieldAudioTtsPricePerMillionChars, group.FieldAudioSttPricePerHour, group.FieldProfitMinMargin, group.FieldProfitSafetyBuffer:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldDynamicRateMarkup:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field dynamic_rate_markup", values[i])
			} else if value.Valid {
				_m.DynamicRateMarkup = value.Float64
			}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("dynamic_rate_markup=")
	builder.WriteString(fmt.Sprintf("%v", _m.DynamicRateMarkup))
	builder.WriteString(", ")
	builder.WriteString("dynamic_rate_source_multiplier=")
	builder.WriteString(fmt.Sprintf("%v", _m.DynamicRateSourceMultiplier))
	builder.WriteString(", ")
