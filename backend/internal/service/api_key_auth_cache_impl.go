...
const apiKeyAuthSnapshotVersion = 25 // v25: fork multi-group routes/profit controls/group Fast + upstream group model_allowlist (renamed from models_list_config, enforcing semantics)
