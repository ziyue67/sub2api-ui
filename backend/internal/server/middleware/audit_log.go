...
var auditActionOverrides = map[string]string{
	...
	"POST /api/v1/admin/accounts/:id/proxy-lanes":             "admin.accounts.proxy_lanes.create",
	"PUT /api/v1/admin/accounts/:id/proxy-lanes/:lane_id":     "admin.accounts.proxy_lanes.update",
	"DELETE /api/v1/admin/accounts/:id/proxy-lanes/:lane_id":  "admin.accounts.proxy_lanes.delete",
