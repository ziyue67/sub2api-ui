...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/ziyue67/sub2api-ui:latest
...
SUB2API_IMAGE=ghcr.io/ziyue67/sub2api-ui:latest # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
