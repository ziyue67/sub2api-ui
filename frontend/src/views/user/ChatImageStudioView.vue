    ...
    >
      ...
      <aside class="studio-rail" :class="{ 'studio-rail-mobile-open': railOpen }">
        <div class="studio-settings">
          ...
          <div class="studio-rail-ledger" aria-hidden="true">
            <span>图像会话</span>
      ...
      <main class="studio-main">
        <header class="studio-topbar">
          <div class="studio-topbar-left">
            ...
            <span class="studio-topbar-title">创作台</span>
          </div>
...
/* Scheme 3: keep the studio a working surface rather than a blue chat shell. */
.chat-image-studio {
  --studio-ink: #181711;
  --studio-muted: #716e63;
  --studio-line: #d9d3c5;
  --studio-paper: #f5f2ea;
  --studio-panel: #fffdf8;
  --studio-subtle: #ece8dd;
  --studio-accent: #1e5c42;
  --studio-accent-hover: #174a35;
  --studio-accent-soft: rgba(30, 92, 66, 0.1);
  --studio-warm: #a86e18;
  --studio-warm-soft: rgba(168, 110, 24, 0.12);
  --studio-danger: #9c4e3c;
  --studio-shadow: 0 14px 32px rgba(54, 48, 34, 0.07);
  gap: 0.85rem;
  grid-template-columns: minmax(16rem, 17.25rem) minmax(0, 1fr);
  color: var(--studio-ink);
}

.dark .chat-image-studio {
  --studio-ink: #f4f2ea;
  --studio-muted: #aaa69a;
  --studio-line: #49453b;
  --studio-paper: #1b1b18;
  --studio-panel: #24231f;
  --studio-subtle: #2b2924;
  --studio-accent: #8fc2a5;
  --studio-accent-hover: #acd5b9;
  --studio-accent-soft: rgba(143, 194, 165, 0.12);
  --studio-warm: #e0b66a;
  --studio-warm-soft: rgba(224, 182, 106, 0.14);
  --studio-danger: #e09a8d;
  --studio-shadow: 0 16px 36px rgba(0, 0, 0, 0.18);
}

.chat-image-studio .studio-rail,
.chat-image-studio .studio-main {
...
.dark .chat-image-studio .studio-rail,
.dark .chat-image-studio .studio-main {
  border-color: var(--studio-line);
  background: var(--studio-panel);
}
...
.chat-image-studio .studio-rail,
.chat-image-studio .studio-main,
.chat-image-studio .studio-assistant-body,
.chat-image-studio .studio-user-bubble,
.chat-image-studio .studio-composer-shell {
  box-shadow: none;
}

.chat-image-studio .studio-settings {
  gap: 0.6rem;
  border-bottom-color: var(--studio-line);
  padding: 0.85rem 0.9rem 0.7rem;
}

.chat-image-studio .studio-rail-ledger {
  display: flex;
  align-items: center;
  justify-content: space-between;
  gap: 0.65rem;
...
.chat-image-studio .studio-rail-ledger strong {
...
.chat-image-studio .studio-rail-actions {
  gap: 0.55rem;
  padding: 0.75rem 0.85rem 0;
}

.chat-image-studio .studio-session-list {
  padding: 0.65rem;
}

.chat-image-studio .studio-session-item {
  gap: 0.35rem;
  border: 1px solid transparent;
  border-radius: 7px;
  color: var(--studio-ink);
...
.chat-image-studio .studio-session-select {
  gap: 0.55rem;
  padding: 0.52rem;
}

.chat-image-studio .studio-session-item:hover,
.chat-image-studio .studio-session-item-active {
...
.dark .chat-image-studio .studio-session-item,
.dark .chat-image-studio .studio-session-delete,
.dark .chat-image-studio .studio-icon-action {
  color: var(--studio-muted);
}

.dark .chat-image-studio .studio-session-item:hover,
.dark .chat-image-studio .studio-session-item-active {
  border-color: rgba(143, 194, 165, 0.28);
  background: var(--studio-accent-soft);
  color: var(--studio-accent);
}

.chat-image-studio .studio-session-delete,
.chat-image-studio .studio-icon-action,
.chat-image-studio .studio-queue-button,
.chat-image-studio .studio-preview-close {
  border-radius: 7px;
  color: var(--studio-muted);
}

.chat-image-studio .studio-session-delete:hover:not(:disabled),
.chat-image-studio .studio-icon-action:hover:not(:disabled),
.chat-image-studio .studio-queue-button:hover {
...
.chat-image-studio .studio-queue-button-active {
  border-color: rgba(30, 92, 66, 0.32);
  background: var(--studio-accent-soft);
  color: var(--studio-accent);
}

.chat-image-studio .studio-queue-count {
  border-radius: 5px;
  background: var(--studio-subtle);
  color: inherit;
}

.dark .chat-image-studio .studio-queue-button,
.dark .chat-image-studio .studio-queue-count {
  border-color: var(--studio-line);
  background: var(--studio-panel);
  color: var(--studio-muted);
}

.dark .chat-image-studio .studio-queue-button-active {
  background: var(--studio-accent-soft);
  color: var(--studio-accent);
}

.chat-image-studio .studio-topbar,
.chat-image-studio .studio-section-head {
  border-bottom-color: var(--studio-line);
...
.chat-image-studio .studio-topbar-title {
  color: var(--studio-ink);
...
.chat-image-studio .studio-tabs,
.chat-image-studio .studio-mode-cluster {
  gap: 0.2rem;
  border-color: var(--studio-line);
  border-radius: 7px;
  background: var(--studio-subtle);
...
.chat-image-studio .studio-mode-switch {
  background: transparent;
}

.chat-image-studio .studio-tab,
.chat-image-studio .studio-mode-button {
  border-radius: 5px;
  color: var(--studio-muted);
  font-size: 0.75rem;
}

.chat-image-studio .studio-tab-active,
.chat-image-studio .studio-mode-button-active {
  background: var(--studio-panel);
  color: var(--studio-accent);
  box-shadow: 0 3px 8px rgba(54, 48, 34, 0.08);
}

.dark .chat-image-studio .studio-tabs,
.dark .chat-image-studio .studio-mode-cluster {
  border-color: var(--studio-line);
  background: var(--studio-subtle);
}

.dark .chat-image-studio .studio-tab,
.dark .chat-image-studio .studio-mode-button {
  color: var(--studio-muted);
}

.dark .chat-image-studio .studio-tab-active,
.dark .chat-image-studio .studio-mode-button-active {
  background: var(--studio-panel);
  color: var(--studio-accent);
}

.chat-image-studio .studio-status-chip {
  border: 1px solid var(--studio-line);
  border-radius: 5px;
  background: var(--studio-subtle);
  color: var(--studio-muted);
...
.chat-image-studio .studio-status-chip-live {
  border-color: rgba(168, 110, 24, 0.26);
  background: var(--studio-warm-soft);
  color: var(--studio-warm);
}

.dark .chat-image-studio .studio-status-chip {
  background: var(--studio-subtle);
  color: var(--studio-muted);
}

.dark .chat-image-studio .studio-status-chip-live {
  background: var(--studio-warm-soft);
  color: var(--studio-warm);
}

.chat-image-studio .studio-messages {
  background: var(--studio-paper);
  padding: 0 1rem 0.75rem;
}

.dark .chat-image-studio .studio-messages {
  background: var(--studio-paper);
}

.chat-image-studio .studio-empty {
  min-height: 420px;
...
.chat-image-studio .studio-empty-icon,
.chat-image-studio .studio-avatar,
.chat-image-studio .studio-generating-icon {
...
.dark .chat-image-studio .studio-empty-icon,
.dark .chat-image-studio .studio-avatar,
.dark .chat-image-studio .studio-generating-icon {
  border-color: rgba(143, 194, 165, 0.25);
  background: var(--studio-accent-soft);
  color: var(--studio-accent);
}

.chat-image-studio .studio-message-stack {
  gap: 0.85rem;
  padding: 1rem 0;
}
...
.dark .chat-image-studio .studio-assistant-body {
  border-color: var(--studio-line);
  background: var(--studio-panel);
}
...
.dark .chat-image-studio .studio-user-bubble {
  border-color: var(--studio-accent);
  background: var(--studio-accent);
  color: #1b1b18;
}

.chat-image-studio .studio-user-bubble .studio-message-content,
.chat-image-studio .studio-user-bubble .studio-message-toolbar,
.chat-image-studio .studio-user-bubble .studio-message-action {
  color: inherit;
}

.chat-image-studio .studio-message-toolbar,
.chat-image-studio .studio-image-card-footer {
  color: var(--studio-muted);
}

.chat-image-studio .studio-image-batchbar,
.chat-image-studio .studio-gallery-batchbar {
  border: 1px solid var(--studio-line);
  border-radius: 7px;
  background: var(--studio-subtle);
  color: var(--studio-muted);
...
.chat-image-studio .studio-text-action,
.chat-image-studio .studio-message-action {
  border-radius: 5px;
  color: var(--studio-muted);
}

.chat-image-studio .studio-text-action:hover:not(:disabled),
.chat-image-studio .studio-message-action:hover:not(:disabled) {
  border-color: rgba(30, 92, 66, 0.24);
  background: var(--studio-accent-soft);
  color: var(--studio-accent);
}

.chat-image-studio .studio-message-content {
  color: var(--studio-ink);
}

.dark .chat-image-studio .studio-message-content {
  color: var(--studio-ink);
}

.chat-image-studio .studio-image-card,
.chat-image-studio .studio-gallery-card,
.chat-image-studio .studio-task-row {
  border-color: var(--studio-line);
  border-radius: 8px;
  background: var(--studio-panel);
  box-shadow: 0 8px 18px rgba(54, 48, 34, 0.05);
}

.dark .chat-image-studio .studio-image-card,
.dark .chat-image-studio .studio-gallery-card,
.dark .chat-image-studio .studio-task-row {
  border-color: var(--studio-line);
  background: var(--studio-panel);
}

.chat-image-studio .studio-image-card-selected {
  border-color: var(--studio-accent);
  box-shadow: 0 0 0 3px var(--studio-accent-soft);
}

.chat-image-studio .studio-image-preview,
.chat-image-studio .studio-gallery-preview {
  background: var(--studio-subtle);
}

.dark .chat-image-studio .studio-image-preview,
.dark .chat-image-studio .studio-gallery-preview {
  background: var(--studio-subtle);
}

.chat-image-studio .studio-image-select-toggle,
.chat-image-studio .studio-gallery-download {
  border-color: var(--studio-line);
  border-radius: 6px;
  background: var(--studio-panel);
  color: var(--studio-ink);
  box-shadow: 0 8px 16px rgba(54, 48, 34, 0.14);
}

.chat-image-studio .studio-image-select-toggle:hover,
.chat-image-studio .studio-image-select-toggle-active,
.chat-image-studio .studio-gallery-download:hover {
  border-color: var(--studio-accent);
  background: var(--studio-accent);
  color: #fffdf8;
}

.chat-image-studio .studio-image-card-footer > span {
  border-radius: 4px;
  background: var(--studio-subtle);
  color: var(--studio-muted);
}

.dark .chat-image-studio .studio-image-card-footer > span {
  background: var(--studio-subtle);
}

.chat-image-studio .studio-generating {
  border: 1px solid var(--studio-line);
  border-radius: 8px;
  background: var(--studio-subtle);
}

.dark .chat-image-studio .studio-generating {
  background: var(--studio-subtle);
}

.chat-image-studio .studio-generating-preview {
  border-radius: 7px;
  background: var(--studio-accent-soft);
}

.dark .chat-image-studio .studio-generating-preview {
  background: var(--studio-accent-soft);
}

.chat-image-studio .studio-generating-shine {
  background: linear-gradient(90deg, transparent, rgba(255, 253, 248, 0.62), transparent);
}

.dark .chat-image-studio .studio-generating-shine {
  background: linear-gradient(90deg, transparent, rgba(244, 242, 234, 0.14), transparent);
}

.chat-image-studio .studio-composer {
...
.dark .chat-image-studio .studio-composer-shell {
  border-color: var(--studio-line);
  background: var(--studio-subtle);
}

.chat-image-studio .studio-input,
.dark .chat-image-studio .studio-input {
  color: var(--studio-ink);
}

.chat-image-studio .studio-input::placeholder {
  color: var(--studio-muted);
}

.chat-image-studio .studio-image-params-popover {
  border-color: var(--studio-line);
  border-radius: 8px;
  background: var(--studio-panel);
  box-shadow: var(--studio-shadow);
...
.dark .chat-image-studio .studio-image-params-popover {
  border-color: var(--studio-line);
  background: var(--studio-panel);
}

.chat-image-studio .studio-image-params-callout {
  border-color: rgba(168, 110, 24, 0.28);
  border-radius: 6px;
  background: var(--studio-warm-soft);
  color: var(--studio-muted);
}

.chat-image-studio .studio-image-params-callout strong,
.dark .chat-image-studio .studio-image-params-callout strong {
  color: var(--studio-warm);
}

.dark .chat-image-studio .studio-image-params-callout {
  border-color: rgba(224, 182, 106, 0.28);
  background: var(--studio-warm-soft);
  color: var(--studio-muted);
}

.chat-image-studio .studio-control-field > span,
.chat-image-studio .studio-image-params-note,
.dark .chat-image-studio .studio-control-field > span,
.dark .chat-image-studio .studio-image-params-note {
  color: var(--studio-muted);
}

.chat-image-studio .studio-circle-action,
.chat-image-studio .studio-send-button {
  width: 2.35rem;
  height: 2.35rem;
  border-radius: 7px;
}
...
.chat-image-studio .studio-circle-action:hover:not(:disabled),
.chat-image-studio .studio-circle-action-active {
  border-color: var(--studio-accent);
  background: var(--studio-accent-soft);
  color: var(--studio-accent);
}
...
.chat-image-studio .studio-send-button:hover:not(:disabled) {
  background: var(--studio-accent-hover);
}

.dark .chat-image-studio .studio-circle-action {
  border-color: var(--studio-line);
  background: var(--studio-panel);
  color: var(--studio-muted);
}

.dark .chat-image-studio .studio-circle-action:hover:not(:disabled),
.dark .chat-image-studio .studio-circle-action-active {
  border-color: var(--studio-accent);
  background: var(--studio-accent-soft);
  color: var(--studio-accent);
}

.dark .chat-image-studio .studio-send-button {
  color: #1b1b18;
}

.chat-image-studio .studio-mode-model-select :deep(.select-trigger) {
  border-left-color: var(--studio-line);
  color: var(--studio-ink);
}

.chat-image-studio :deep(.select-trigger) {
  border-color: var(--studio-line);
  border-radius: 7px;
  background: var(--studio-panel);
  color: var(--studio-ink);
...
.chat-image-studio :deep(.select-trigger:hover),
.chat-image-studio :deep(.select-trigger-open) {
  border-color: var(--studio-accent);
  box-shadow: 0 0 0 3px var(--studio-accent-soft);
}

.chat-image-studio :deep(.select-value),
.chat-image-studio :deep(.select-icon),
.chat-image-studio .studio-mode-model-select :deep(.select-value),
.chat-image-studio .studio-mode-model-select :deep(.select-icon) {
  color: var(--studio-ink);
}

.chat-image-studio .studio-tool-button {
  height: 2.2rem;
  border-color: var(--studio-line);
  border-radius: 6px;
  background: var(--studio-panel);
...
.chat-image-studio .studio-params-button {
  border-color: transparent;
  background: transparent;
}

.chat-image-studio .studio-tool-button:hover,
.chat-image-studio .studio-tool-button-active,
.chat-image-studio .studio-params-button:hover:not(:disabled),
.chat-image-studio .studio-params-button.studio-tool-button-active {
  border-color: rgba(30, 92, 66, 0.26);
  background: var(--studio-accent-soft);
  color: var(--studio-accent);
}

.dark .chat-image-studio .studio-tool-button {
  border-color: var(--studio-line);
  background: var(--studio-panel);
  color: var(--studio-muted);
}

.dark .chat-image-studio .studio-params-button {
  border-color: transparent;
  background: transparent;
}

.dark .chat-image-studio .studio-tool-button:hover,
.dark .chat-image-studio .studio-tool-button-active,
.dark .chat-image-studio .studio-params-button:hover:not(:disabled),
.dark .chat-image-studio .studio-params-button.studio-tool-button-active {
  border-color: rgba(143, 194, 165, 0.3);
  background: var(--studio-accent-soft);
  color: var(--studio-accent);
}

.chat-image-studio .studio-reference-bubble {
  border-color: var(--studio-line);
  border-radius: 8px;
  background: var(--studio-panel);
  box-shadow: var(--studio-shadow);
...
.dark .chat-image-studio .studio-reference-bubble {
  border-color: var(--studio-line);
  background: var(--studio-panel);
}

.chat-image-studio .studio-reference-remove {
  border-color: var(--studio-line);
  background: var(--studio-panel);
  color: var(--studio-muted);
}

.chat-image-studio .studio-reference-remove:hover {
  background: var(--studio-subtle);
  color: var(--studio-ink);
}

.chat-image-studio .studio-gallery {
  background: var(--studio-paper);
}

/* Queue and prompt-market portals sit outside the page tree, so they own their palette. */
.studio-queue-overlay,
.studio-prompt-market-overlay {
...
.studio-queue-modal,
.studio-prompt-market-panel {
  --studio-modal-ink: #181711;
  --studio-modal-muted: #716e63;
  --studio-modal-line: #d9d3c5;
  --studio-modal-panel: #fffdf8;
  --studio-modal-subtle: #ece8dd;
  --studio-modal-accent: #1e5c42;
  border-color: var(--studio-modal-line);
  border-radius: 8px;
  background: var(--studio-modal-panel);
  box-shadow: 0 24px 68px rgba(27, 25, 18, 0.2);
  color: var(--studio-modal-ink);
}

.dark .studio-queue-modal,
.dark .studio-prompt-market-panel {
  --studio-modal-ink: #f4f2ea;
  --studio-modal-muted: #aaa69a;
  --studio-modal-line: #49453b;
  --studio-modal-panel: #24231f;
  --studio-modal-subtle: #2b2924;
  --studio-modal-accent: #8fc2a5;
  border-color: var(--studio-modal-line);
  background: var(--studio-modal-panel);
}
...
.studio-queue-modal-icon {
  ...
  color: var(--studio-modal-accent);
}

.dark .studio-queue-modal-icon {
  border-color: rgba(143, 194, 165, 0.28);
  background: rgba(143, 194, 165, 0.12);
  color: var(--studio-modal-accent);
}
...
.dark .studio-prompt-market-header p,
.studio-prompt-market-empty {
  color: var(--studio-modal-muted);
}

.studio-prompt-market-search {
  border-color: var(--studio-modal-line);
  border-radius: 6px;
  background: var(--studio-modal-subtle);
  color: var(--studio-modal-ink);
}
...
.studio-prompt-market-card {
  ...
  border-radius: 7px;
  background: var(--studio-modal-panel);
  box-shadow: 0 8px 16px rgba(54, 48, 34, 0.05);
}
...
.studio-queue-modal .studio-task-row {
  border-color: var(--studio-modal-line);
  border-radius: 7px;
  background: var(--studio-modal-panel);
  box-shadow: none;
...
.dark .studio-queue-modal .studio-task-row {
  border-color: var(--studio-modal-line);
  background: var(--studio-modal-panel);
}

.studio-queue-modal .studio-status-chip {
  border: 1px solid var(--studio-modal-line);
  border-radius: 5px;
  background: var(--studio-modal-subtle);
  color: var(--studio-modal-muted);
}

.studio-queue-modal .studio-status-chip-live {
  border-color: rgba(168, 110, 24, 0.28);
  background: rgba(168, 110, 24, 0.12);
  color: #a86e18;
}

.studio-queue-modal .btn-secondary,
.studio-prompt-market-panel .studio-tool-button {
  border-color: var(--studio-modal-line);
  border-radius: 6px;
  background: var(--studio-modal-panel);
  color: var(--studio-modal-muted);
...
.studio-queue-modal .btn-secondary:hover,
.studio-prompt-market-panel .studio-tool-button:hover:not(:disabled) {
  border-color: var(--studio-modal-accent);
  background: rgba(30, 92, 66, 0.1);
  color: var(--studio-modal-accent);
}

.studio-prompt-market-source :deep(.select-trigger) {
  min-height: 2.5rem;
  border-color: var(--studio-modal-line);
  border-radius: 6px;
  background: var(--studio-modal-panel);
...
.studio-prompt-market-source :deep(.select-trigger:hover),
.studio-prompt-market-source :deep(.select-trigger-open) {
  border-color: var(--studio-modal-accent);
  box-shadow: 0 0 0 3px rgba(30, 92, 66, 0.1);
}

.studio-prompt-market-source :deep(.select-value),
.studio-prompt-market-source :deep(.select-icon) {
  color: var(--studio-modal-ink);
}

.dark .studio-prompt-market-source :deep(.select-trigger) {
  border-color: var(--studio-modal-line);
  background: var(--studio-modal-panel);
}

.dark .studio-prompt-market-source :deep(.select-value),
.dark .studio-prompt-market-source :deep(.select-icon) {
  color: var(--studio-modal-ink);
}
...
.studio-preview-tool,
.studio-preview-nav {
  border-color: rgba(244, 242, 234, 0.2);
  border-radius: 7px;
...
.studio-preview-tool:hover:not(:disabled),
.studio-preview-nav:hover:not(:disabled) {
  border-color: rgba(143, 194, 165, 0.56);
  background: rgba(143, 194, 165, 0.18);
  color: #acd5b9;
}
