...
/* Scheme 3: custom pages use the same paper frame as the rest of the user console. */
.custom-page-layout {
  --custom-ink: #181711;
  --custom-muted: #716e63;
  --custom-line: #d9d3c5;
  --custom-paper: #f5f2ea;
  --custom-panel: #fffdf8;
  --custom-subtle: #ece8dd;
  --custom-accent: #1e5c42;
  --custom-accent-soft: rgba(30, 92, 66, 0.1);
...
.dark .custom-page-layout {
  --custom-ink: #f4f2ea;
  --custom-muted: #aaa69a;
  --custom-line: #49453b;
  --custom-paper: #1b1b18;
  --custom-panel: #24231f;
  --custom-subtle: #2b2924;
  --custom-accent: #8fc2a5;
  --custom-accent-soft: rgba(143, 194, 165, 0.12);
}
...
.custom-page-layout > .card {
  ...
  box-shadow: 0 14px 32px rgba(54, 48, 34, 0.06) !important;
}

.dark .custom-page-layout > .card {
  border-color: var(--custom-line) !important;
  background: var(--custom-panel) !important;
  box-shadow: 0 16px 36px rgba(0, 0, 0, 0.18) !important;
}

.custom-page-layout .toc-sidebar {
  border-right-color: var(--custom-line);
  background: var(--custom-subtle);
}

/* The console frame has a dark utility override with !important. Keep the
   custom-page paper palette authoritative for the TOC in dark mode too. */
.dark .custom-page-layout .toc-sidebar {
  border-right-color: var(--custom-line) !important;
  background: var(--custom-subtle) !important;
  color: var(--custom-ink) !important;
}

.custom-page-layout .toc-header {
  border-bottom-color: var(--custom-line);
}

.dark .custom-page-layout .toc-header {
  border-bottom-color: var(--custom-line) !important;
  background: var(--custom-subtle) !important;
}

.custom-page-layout .toc-title {
  color: var(--custom-ink);
...
.dark .custom-page-layout .toc-title {
  color: var(--custom-ink) !important;
}

.custom-page-layout .toc-close-btn,
.custom-page-layout .toc-toggle-btn {
...
.dark .custom-page-layout .toc-close-btn,
.dark .custom-page-layout .toc-toggle-btn {
  border-color: var(--custom-line) !important;
  background: var(--custom-panel) !important;
...
.custom-page-layout .toc-close-btn:hover,
.custom-page-layout .toc-toggle-btn:hover {
  background: var(--custom-accent-soft);
  color: var(--custom-accent);
}

.custom-page-layout .toc-item {
  border: 1px solid transparent;
  border-radius: 6px;
  color: var(--custom-muted);
}

.dark .custom-page-layout .toc-item {
  color: var(--custom-muted) !important;
}

.custom-page-layout .toc-item:hover,
.custom-page-layout .toc-item.toc-active {
  border-color: rgba(30, 92, 66, 0.22);
  background: var(--custom-accent-soft);
  color: var(--custom-accent);
}

.dark .custom-page-layout .toc-item:hover,
.dark .custom-page-layout .toc-item.toc-active {
  border-color: rgba(143, 194, 165, 0.28);
  background: var(--custom-accent-soft);
  color: var(--custom-accent);
}

.custom-page-layout .markdown-page-content {
  background: var(--custom-paper);
  color: var(--custom-ink);
}

.custom-page-layout .markdown-page-content h1,
.custom-page-layout .markdown-page-content h2,
.custom-page-layout .markdown-page-content h3,
.custom-page-layout .markdown-page-content h4 {
  color: var(--custom-ink);
...
.custom-page-layout .markdown-page-content a {
  color: var(--custom-accent);
}

.custom-page-layout .markdown-page-content blockquote {
...
.custom-page-layout .markdown-page-content code {
  border: 1px solid var(--custom-line);
  border-radius: 4px;
  background: var(--custom-subtle);
  color: var(--custom-ink);
...
.custom-page-layout .markdown-page-content pre {
  border: 1px solid var(--custom-line);
  border-radius: 7px;
  background: #1e2b24;
  color: #f4f2ea;
...
.custom-page-layout .markdown-page-content hr {
  border-color: var(--custom-line);
}
...
.custom-page-layout .custom-open-fab {
  border-color: var(--custom-line);
  border-radius: 6px;
  background: var(--custom-panel);
  color: var(--custom-ink);
  box-shadow: 0 8px 18px rgba(54, 48, 34, 0.08);
}

.custom-page-layout .custom-open-fab:hover {
