export default {
  dashboard: {
    ...
    loadFailed: '仪表盘暂时无法加载',
    loadFailedHint: '请重新加载；若持续失败，请稍后再试。',
    retry: '重新加载',
    redeemCode: '兑换码',
  ...
  keys: {
    ...
    routeCooldown: '冷却秒数',
    addRouteGroup: '添加分组',
    removeRouteGroup: '移除分组',
    groupRouteRequired: '请至少添加一个路由分组',
    groupRouteInvalid: '分组、优先级和权重必须为正整数，冷却秒数不能小于 0',
    groupRouteDuplicate: '同一个分组只能添加一次',
    usage: '用量',
    today: '今日',
    total: '近30天',
    quota: '额度',
