export default {
    accounts: {
      ...
      proxyLanes: {
        ...
        manageShort: '线路',
        title: '账号线路与并发',
        description: '为同一个账号配置多个独立出口。每条线路单独限流，账号总并发作为硬上限。',
        aggregate: '总并发（实时）',
        aggregateHint: '总并发为 0 表示不限制；线路并发为 0 表示该线路不设上限。所有线路合计不会超过账号总并发。',
        aggregateSaved: '账号总并发已保存',
        aggregateSaveFailed: '账号总并发保存失败',
        aggregateWarning: '线路上限合计为 {total}，高于账号总并发 {aggregate}。运行时仍以账号总并发为硬上限，建议调整线路上限。',
        laneCount: '{count} 条线路',
        laneCountHint: '线路按优先级、权重和调度状态参与请求分配。',
        add: '新增线路',
        edit: '编辑线路',
        empty: '还没有配置独立线路',
        emptyHint: '未配置线路时，账号继续使用原有代理和并发配置。',
        name: '线路名称',
        namePlaceholder: '例如 IP1、IP2、本地直连',
        transport: '传输方式',
        proxy: '代理',
        direct: '本地直连',
        proxyEndpoint: '代理出口',
        selectProxy: '请选择代理',
        noProxies: '暂无可用代理，请先在代理管理中添加。',
        laneCap: '线路并发',
        concurrencyHint: '0 表示不限制，但仍受账号总并发约束。',
        weight: '权重',
        priority: '优先级',
        status: '状态',
        statusActive: '启用',
        ...
        unlimited: '不限',
        directEndpoint: '本机网络直连',
        unknownEndpoint: '出口信息未加载',
        invalidName: '请输入线路名称。',
        proxyRequired: '代理线路必须选择代理出口。',
        loadFailed: '线路加载失败',
        saveFailed: '线路保存失败',
        deleteFailed: '线路删除失败',
        deleteConfirm: '确定删除线路“{name}”吗？正在使用中的请求不会被中断。',
        created: '线路已创建',
        saved: '线路已保存',
        deleted: '线路已删除'
      },
