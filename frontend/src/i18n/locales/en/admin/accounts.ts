export default {
    accounts: {
      ...
      proxyLanes: {
        manage: 'Lanes & Concurrency',
        manageShort: 'Lanes',
        title: 'Account lanes & concurrency',
        description: 'Configure multiple independent egresses for one account. Each lane has its own cap, while the account cap remains the hard limit.',
        aggregate: 'Total concurrency (live)',
        aggregateHint: 'A total of 0 means unlimited; a lane cap of 0 means unlimited for that lane. The sum of all lanes never exceeds the account cap.',
        aggregateSaved: 'Account total concurrency saved',
        aggregateSaveFailed: 'Failed to save account total concurrency',
        aggregateWarning: 'Configured lane caps total {total}, above the account cap {aggregate}. Runtime admission still enforces the account cap; consider lowering the lane caps.',
        laneCount: '{count} lane(s)',
        laneCountHint: 'Lanes are scheduled using priority, weight, and schedulable status.',
        add: 'Add lane',
        edit: 'Edit lane',
        empty: 'No independent lanes configured',
        emptyHint: 'Without lanes, this account keeps using its legacy proxy and concurrency settings.',
        name: 'Lane name',
        namePlaceholder: 'e.g. IP1, IP2, local direct',
        transport: 'Transport',
        proxy: 'Proxy',
        direct: 'Direct',
        proxyEndpoint: 'Proxy endpoint',
        selectProxy: 'Select a proxy',
        noProxies: 'No proxies available. Add one in Proxy Management first.',
        laneCap: 'Lane concurrency',
        concurrencyHint: '0 means unlimited for this lane, still bounded by the account cap.',
        weight: 'Weight',
        priority: 'Priority',
        status: 'Status',
        statusActive: 'Active',
        ...
        unlimited: 'Unlimited',
        directEndpoint: 'Local network direct',
        unknownEndpoint: 'Endpoint details unavailable',
        invalidName: 'Enter a lane name.',
        proxyRequired: 'A proxy lane must select a proxy endpoint.',
        loadFailed: 'Failed to load lanes',
        saveFailed: 'Failed to save lane',
        deleteFailed: 'Failed to delete lane',
        deleteConfirm: 'Delete lane "{name}"? In-flight requests will not be interrupted.',
