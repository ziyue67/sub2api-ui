export default {
  ...
  keys: {
    ...
    routeWeight: 'Weight',
    routeCooldown: 'Cooldown seconds',
    addRouteGroup: 'Add group',
    removeRouteGroup: 'Remove group',
    groupRouteRequired: 'Add at least one route group',
    groupRouteInvalid: 'Group, priority, and weight must be positive integers; cooldown seconds cannot be negative',
    groupRouteDuplicate: 'Each group can only be added once',
    usage: 'Usage',
    today: 'Today',
    total: 'Last 30d',
    quota: 'Quota',
