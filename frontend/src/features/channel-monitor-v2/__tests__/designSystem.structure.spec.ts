...
describe('channel-monitor-v2 third-version design structure', () => {
  it('user shell uses ledger controls, KPI strip, and internal table scroll', () => {
    ...
    // Upstream mobile monitor additions are present under Scheme3 skin.
    expect(src).toContain('scheme3-v2-mobile-card')
    expect(src).toContain('scheme3-v2-mobile-metrics')
